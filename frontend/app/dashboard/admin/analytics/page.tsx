 ...
 * Cross-Filter/Revenue tabs, plus a "Growth Signals" tab (GAP-03/GAP-04's
 * signup/retention/churn/revenue time series) that every anomaly alert
 * deep-links into pre-filtered (?metric=&from=&to=) — per GAP-03's
 * acceptance criterion that an alert never opens the generic homepage.
 */
        ...
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm text-muted-foreground">
            {focusedMetric
              ...
              : "Platform activity, onboarding drop-off, feature adoption, and the growth signals that feed anomaly alerts and scheduled reports."}
